import { c as createComponent, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, m as maybeRenderHead, h as renderScript, r as renderComponent, d as addAttribute, b as createAstro, j as defineScriptVars, i as renderSlot, F as Fragment, k as renderHead } from './astro/server_DTu46K8G.mjs';
import 'kleur/colors';
import './index_MaT6fT73.mjs';
import { $ as $$Image } from './_astro_assets_Cdi1R-PC.mjs';
import 'clsx';
/* empty css                         */
...
const $$ShortForm = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<form id="newsletter-form" class="bg-[#292A32] px-10 py-14 rounded-[14px] gap-5 h-full flex flex-col sm:flex-row items-center justify-center"> <div class="w-full sm:w-[55%]"> <input type="email" id="newsletter-email" name="email" placeholder="your@email.com" required class="bg-transparent w-full px-[35px] py-5 border rounded-[14px] focus:outline-none text-white"> </div> <button type="submit" name="submit" class="w-full sm:w-[45%] btn-tertiary">Subscribe to Insights</button> </form> <div id="newsletter-status" class="mt-4 text-center text-gray hidden"></div> ${renderScript($$result, "/tmp/cc-agent/60266810/project/src/components/ui/ShortForm.astro?astro&type=script&index=0&lang.ts")}`;
}, "/tmp/cc-agent/60266810/project/src/components/ui/ShortForm.astro", void 0);
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="sm:px-5"> <div class="w-full max-w-[1240px] mx-auto"> <div class="px-[15px] bg-dark text-gray py-[55px] lg:px-[60px] sm:rounded-t-[45px]"> <div> <div class="flex flex-col lg:flex-row gap-7 items-center justify-between"> <picture> <a href="/"> ${renderComponent($$result, "Image", $$Image, { "src": Logo, "alt": "TheLearnBetter.co" })} </a> </picture> <ul class="flex flex-col sm:flex-row gap-5"> ${links.map((link) => {
  ...
  })} </ul> </div> <div class="flex flex-col lg:flex-row mt-[66px] mb-[51px]"> <div class="flex text-center lg:text-start flex-col w-full lg:w-[30%]"> <h3 class="mb-5 text-center md:text-left text-2xl text-green">Get In Touch</h3> <div class="flex flex-col justify-between gap-4"> <span> Email: hello@thelearnbetter.co </span> <span class="lg:w-3/4">
Helping learntech companies reach educational institutions worldwide
</span> </div> </div> <div class="flex-grow my-10 lg:my-0 lg:ml-12"> ${renderComponent($$result, "ShortForm", $$ShortForm, {})} </div> </div> </div> <div class="h-[1px] bg-gray mb-5"></div> <div class="flex flex-col lg:flex-row h-20 justify-center mt-4 text-center md:justify-between md:mt-0"> <span>© 2024 The Learn Better Company. All rights reserved.</span> </div> </div> </div> </section>`;
}, "/tmp/cc-agent/60266810/project/src/components/ui/Footer.astro", void 0);
...
}, "/tmp/cc-agent/60266810/project/node_modules/astro-navbar/src/Astronav.astro", void 0);
...
}, "/tmp/cc-agent/60266810/project/node_modules/astro-navbar/src/components/MenuIcon.astro", void 0);
...
}, "/tmp/cc-agent/60266810/project/node_modules/astro-navbar/src/components/OpenIcon.astro", void 0);
...
}, "/tmp/cc-agent/60266810/project/node_modules/astro-navbar/src/components/CloseIcon.astro", void 0);
...
}, "/tmp/cc-agent/60266810/project/node_modules/astro-navbar/src/components/MenuItems.astro", void 0);
...
}, "/tmp/cc-agent/60266810/project/node_modules/astro-navbar/src/components/Dropdown.astro", void 0);
...
}, "/tmp/cc-agent/60266810/project/node_modules/astro-navbar/src/components/DropdownSubmenu.astro", void 0);
...
}, "/tmp/cc-agent/60266810/project/node_modules/astro-navbar/src/components/DropdownItems.astro", void 0);
...
}, "/tmp/cc-agent/60266810/project/node_modules/astro-navbar/src/components/StickyHeader.astro", void 0);
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  ...
  const navButton = { href: "/#contact", label: "Start a Conversation" };
...
}, "/tmp/cc-agent/60266810/project/src/components/ui/Navbar.astro", void 0);

const title = "TheLearnBetter.co";
const image = {"src":"/cover.png","alt":"TheLearnBetter.co - Growth Agency for LearnTech"};
const siteData = {
  title,
  image,
};
...
}, "/tmp/cc-agent/60266810/project/src/layouts/MainHead.astro", void 0);
...
const $$MainLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-ouamjn2i> ${renderComponent($$result, "MainHead", $$MainHead, { ...props, "data-astro-cid-ouamjn2i": true })}${renderScript($$result, "/tmp/cc-agent/60266810/project/src/layouts/MainLayout.astro?astro&type=script&index=0&lang.ts")}${maybeRenderHead()}<body class="bg-white font-grotesk" data-astro-cid-ouamjn2i> <main data-astro-cid-ouamjn2i> ${renderComponent($$result, "Navbar", $$Navbar, { "data-astro-cid-ouamjn2i": true })} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-ouamjn2i": true })} </main> </body></html>`;
}, "/tmp/cc-agent/60266810/project/src/layouts/MainLayout.astro", void 0);
